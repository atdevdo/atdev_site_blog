...
!(function (a) {
		...
		}
		{
			...
			;(n = W.slice(J).split(':')),
				...
				'iFrameResizer' in window &&
					...
					(m =
						'heightCalculationMethod' in n
							? n.heightCalculationMethod
							: m),
					(M =
						'widthCalculationMethod' in n
							? n.widthCalculationMethod
							: M),
					(m = t(m, 'height')),
					(M = t(M, 'width')))
		}
	...
	function we(e, t) {
		for (
			...
			i <
				(n =
					t[u].getBoundingClientRect()[e] + ye('margin' + r, t[u])) &&
				(i = n)
		return (
			(a = Date.now() - a),
			...
			O / 2 < (a = a) &&
				R('Event throttle increased to ' + (O = 2 * a) + 'ms'),
			i
		)
	}
	function e(e) {
