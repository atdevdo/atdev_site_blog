...
const sorted_title_box = document.getElementById('sorted_title')
const sorted_time_box = document.getElementById('sorted_time')
const sorted_category_box = document.getElementById('sorted_category')
const sorted_date_box = document.getElementById('sorted_date')
const not_sorted_box = document.getElementById('not_sorted')

const sort_by_title_btn = document.getElementById('sort_btn_title')
const sort_by_time_to_read_btn = document.getElementById('sort_btn_time_read')
const sort_by_category_btn = document.getElementById('sort_btn_category')
const sort_by_date_btn = document.getElementById('sort_btn_date')
